...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/admin/assets/js/plugins/summernote/summernote-bs4.css">
  ...
  <body>
            ...
            <div class="block">
                ...
                <div class="block-content">
                    ...
                    <p class="text-right">
                      ...
                      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#write_document">
                        Write Document
                      </button>
                    </p>


                    <div class="modal fade bd-example-modal-lg" id="write_document"  role="dialog" aria-labelledby="write_document" aria-hidden="true">
                      <form action="{{asset('/store/document')}}" method="POST">
                        @csrf
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <div class="form-group">
                                ...
                                <input class="form-control form-control-lg" id="title" name="title" type="text" placeholder="Document Title">
                              </div>
    ...
    <script src="/admin/assets/js/plugins/summernote/summernote-bs4.min.js"></script>
    <script>
